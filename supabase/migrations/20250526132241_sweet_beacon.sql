/*
  ...
  1. Changes
    - Add payment and check-in fields to cabin_reservations table
    - Create cabin_reservation_payments table for payment tracking
    - Create cabin_reservation_notifications table for email notifications
    - Add RLS policies for new tables
    - Create function to handle late arrivals
  ...
  3. Notes
    ...
    - Payment methods: online, onsite
    - Late threshold set to 2 hours by default
    - Notifications support: confirmation, cancellation, reminder
*/
