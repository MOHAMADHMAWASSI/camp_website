/*
  # Create activities and cabins tables with related tables
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Public can view cabin amenities" ON cabin_amenities;
  DROP POLICY IF EXISTS "Admins can manage cabin amenities" ON cabin_amenities;
  DROP POLICY IF EXISTS "Public can view cabin images" ON cabin_images;
  DROP POLICY IF EXISTS "Admins can manage cabin images" ON cabin_images;
  DROP POLICY IF EXISTS "Public can view cabin availability" ON cabin_availability;
  DROP POLICY IF EXISTS "Admins can manage cabin availability" ON cabin_availability;
EXCEPTION
