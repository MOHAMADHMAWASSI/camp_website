/*
  # Add Reservation Payment and Notification System

  1. Changes
    - Add payment-related columns to cabin_reservations
    - Create new tables for payments and notifications
    - Add RLS policies for new tables
    - Add function for handling late arrivals
